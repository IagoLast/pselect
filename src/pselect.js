var PS = (function Provinces() {
    ...
    self.translateProvSelector = "[data-translate='prov']";
    self.translateMunSelector = "[data-translate='mun']";

    self.translate = function translate() {
        $(self.translateProvSelector).each(function() {
            $(self).text(self.translateProv($(self).text()));
        });
        $(self.translateMunSelector).each(function() {
            $(self).text(self.translateMun($(self).text()));
        });
    };

    self.translateProv = function translateProv(code) {
        var index = parseInt(code);
        index = index - 1;
        return provinces[index].name;
    };

    self.translateMun = function translateMun(code) {
        var index = parseInt(code);
        return municipes[index].name;
    };
    ...
    self.init = function init() {
        ...
        $(self.provSelect).append($('<option>').text(self.defaultProvText).attr('value', -1));
